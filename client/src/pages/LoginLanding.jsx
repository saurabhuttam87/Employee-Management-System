  ...
  const portalOptions = [
    {
      to: "/login/admin",
      title: "Admin Portal",
      description: "Manage emloyees, departments, payroll, and system configuration.",
      icon: ShieldIcon
    },
    {
      to: "/login/employee",
      ...
      <div className="w-full max-w-md animate-fade-in relative-z-10">
        ...
        <div className="space-y-4">
          {portalOptions.map((portal)=> (
            <Link key={portal.to} to={portal.to} className="group block bg-slate-50 border border-slate-200 rounded-lg p-5 sm:p-6 transition-all guration-300 hover:border-indigo-400 hover:indigo-50">
